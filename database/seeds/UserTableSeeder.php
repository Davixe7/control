...
class UserTableSeeder extends Seeder
{
    ...
    public function run()
    {
      ...
      $user_campaign->email = "campaign@control.com";
      ...
      $user_member->email = "center@control.com";
      $user_member->password = bcrypt('123456');
      $user_member->user_id = 2;
      $user_member->save();
      ...
      $user_leader->email = "leadermaster@control.com";
      $user_leader->password = bcrypt('123456');
      $user_leader->user_id = 2;
      $user_leader->save();
